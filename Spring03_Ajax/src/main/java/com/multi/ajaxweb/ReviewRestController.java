 ...
 * DELETE /reviews/10 ===> 10번 게시글 삭제 (D)
...
public class ReviewRestController {
	...
	public final ReviewService rService;//final 변수=> 생성자 주입
	...
	public ModelMap reviewInsert2(ReviewVO vo
		...
		//1.업로드 절대경로 얻기
		String upDir=app.getRealPath("/resources/image");
	...
	public String test() {
		return "Hello World";
		//@RestController를 붙이면 메서드에서 반환하는 문자열이
